    ...
    <div class="W100 scoreContainer">
      ...
      <div class="box-start">
        ...
        <div class="itemCss">
          ...
          <div class="Mb-20">
            <input
              v-model.number="scoreObj.singleScore"
              type="text"
              class="scoreInput"
            />
          </div>
        ...
        <div class="itemCss">
          ...
          <div class="Mb-20">
            <input
              v-model.number="scoreObj.moreScore"
              type="text"
              class="scoreInput"
            />
          </div>
        ...
        <div class="itemCss">
          ...
          <div class="Mb-20">
            <input
              v-model.number="scoreObj.judgScore"
              type="text"
              class="scoreInput"
            />
          </div>
        ...
        <div class="itemCss">
          ...
          <div class="Mb-20">
            <input
              v-model.number="scoreObj.blankScore"
              type="text"
              class="scoreInput"
            />
          </div>
        ...
        <div class="itemCss">
          ...
          <div class="Mb-20">
            <input
              v-model.number="scoreObj.answerScore"
              type="text"
              class="scoreInput"
            />
          </div>
