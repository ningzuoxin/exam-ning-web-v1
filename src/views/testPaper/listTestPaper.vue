<template>
  <div class="app-container">
    ...
    <el-table :data="tableData" height="400px" border style="width: 100%">
      ...
      <el-table-column prop="passedScore" label="及格分" width="80">
      </el-table-column>
      <el-table-column prop="limitedTime" label="限时（秒）" width="100">
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          <el-button type="primary" size="mini" @click="preview(scope.row.id)"
            >预览</el-button
          >
          <el-button
            size="mini"
